...
BenchHub is a data storage framework to facilitate living benchmarks. It
aims to enhance reproducibility and accessibility of benchmarking
studies by making it easier to store, analyse and share benchmarking
data.
...
| 3 [Introduction of benchmarkInsight Class](https://sydneybiox.github.io/BenchHub/articles/v03_intro_bmi.html) |             |
