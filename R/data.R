...
#' 
#' Data set consists of a matrix of abundances of 1192 microbial taxa for 575 samples
#' and a factor vector of classes for Parkinson's disease for the same 575 patients
#' 
#' 
