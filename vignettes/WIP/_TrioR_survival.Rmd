...
Add the metric and evidence into the trioB1

```{r}
trioB1$addMetric("Harrel C-Index", harrelCIndexMetric)
trioB1$addEvidence("surv_obj", surv_obj, c("Harrel C-Index"))
```
...
trioA$addEvidence("get_DO_pathway", get_DO_pathway, c("disease score"))
trioA$data <- data
