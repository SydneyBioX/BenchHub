...
```{r create-trio, message=FALSE, warning=FALSE}
...
In an interactive session, a prompt will be displayed, asking you to briefly describe the dataset. This is useful for any pertinent information that is not recorded by the metadata spreadsheet. 
...
Underneath the hood, Trio creates a wrapper function that calls the metric function with the specified arguments.
